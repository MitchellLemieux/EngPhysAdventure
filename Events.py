...
# Wrote on July 70,2019:
"""
Events, as opposed to Quests, are reoccurring and don't necessarily advance the storyline.
They're more like game mechanics that need a certain condition to be met.

"""

from GameFunctions import * # importing the global dictionaries/values so they can be changed
import time
...
def events():
    ...
    if not ENEMIES['sir william mcmaster'].alive and QUESTS['create chaos']:
        ...
        return 2
        # TODO Bug where when story returns can't do any other quests, change into EngPhys ebta_story and Quests
    else:
        return 0
