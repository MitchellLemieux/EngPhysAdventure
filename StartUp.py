...
Equipment("Wool Sweater",(5,3,1),"WoolSweater.jpg","Just like grandma makes.","bosy",(1,4,6)),
#Hand Items
...
Equipment("Dirty Needle",(0,1,1),"Needle.jpg","This isn't clean. Somone find me a SharpXchange!",'hand',(7,0,5)),
...
Equipment("Space Pop",(1,7,2),"SpacePop.jgp","Get ready to go to space pop city.","hand",(4,0,10)),
...
Equipment("RCA TV",(5,6,1),"RCATV.jpg","They still make these?","hand",(15,20,-999)),
...
Equipment("Febreze",(1,0,1),"Ferbreze.jpg","Kills 99.9% of odour at the source!","hand",(6,0,10)),
#Off-Hand Items
Equipment("Coffee",(2,4,1),"Coffee.jpg","The fuel of thinkers.","off-hand",(3,0,9)),
...
Equipment("Casio",(2,2,1),"Casio.jpg","This one can do integrals. That's illegal.","off-hand",(1,5,10)),
Equipment("Paint Brush",(3,0,1),"Brush.jpg","You can feel the emotions of a failed arts student coursing through this thing.","off-hand",(5,0,5)),
Equipment("Lenovo Laptop",(1,5,2),"Lenovo.jpg","This heap of computing majesty could block bullets... I think...","off-hand",(5,15,-5)),
Equipment("Priceless Painting",(3,0,1),"Painting.jpg","This painting is supposed to be worth millions...","off-hand",(1,10,5)),
Equipment("Brendan Fallons Lunchbox",(3,3,0),"Lunchbox.jpg","The Lunch Box of an Ancient Hero. Full of samosas","off-hand",(5,10,5)),
...
Equipment("Minnicks Glasses",(None),"MinnickGlasses.jpg","The spectacles of a wizard from the High Order of the Ancient Council.","head",(100,100,100)),
...
Equipment("ColdSteel Katana",(None),"katana.jpg","This could probably kill a buffalo fish...","hand",(18,5,10)),
...
Equipment("Solar Cell",(None),"SolarCell.jpg","Harness the power of the Sun!\nI really hope I dont drop this...","off-hand",(1,1,1)),
Equipment("The Solar Ray",(None),"SolarRay.jpg","The literal power of the Sun!","hand",(100,20,50)),
Equipment("Bleach Squirt Bottle",(None),"Bleach.jpg","Probably wouldn't be nice to get sprayed with.","hand",(15,5,20)),
Equipment("Flux Capacitor",(None),"FluxCapacitor.jpg","If only I could go back to 1985...","hand",(1,1,1,)),
Equipment("Pink Donut",(None),"PinkDonut.jpg","This is what fusion is all about?","off-hand",(1,1,1,)),
Equipment("Einsteins Brain",(None),"Brain.jpg","Feel's kind of weird walking around with this...","off-hand",(1,1,1)),
...
Equipment("Gamma Gauntlet",(None),"GammaGauntlet.jpg","You can feel the power radiating from this thing.","hand",(250,100,20)),
...
Enemy("Erik the Sk8r","'Check out this trey flip, pretty tight eh?'",(0,0,0),(15,15,40),20,"eriks frosted tips",None,"","Man, that's dumb!"),
