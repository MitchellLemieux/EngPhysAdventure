...
def Reset():
    ...
    Equipment("Bike Helmet", (3,7,1), "BikeHelmet.jpg", "One of those fast Tour de France ones. Does this belong to Dr. Minnick? Great!", "head", (0,8,10),""),
    ...
    Equipment("Car Keys", (4,2,1), "CarKeys.jpg", "Volkswagen car keys with an 'R' on the keychain. Hmm...", "off-hand", (5,0,5),""),
    ...
    Equipment("EpiPen", (5,7,1), "EpiPen.jpg", "Epinephrine Autoinjector 0.3mg. Replace if discolored. Store at 68C. Incase of alergic reaction remove the top...wait, why are you reading this label? Isn't there something else you should be doing? ", "off-hand", (7,0,5),-2),
    ...
    Equipment("Helm of Orin Bearclaw", (0,2,0), "SkullHelmet.jpg", "A note left beside the helmet says 'A leftover relic from a purple hero'", "head", (35,30,10),""),
