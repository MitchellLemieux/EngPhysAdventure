...
Equipment("Gamma Glove",(None),"GammaGauntlet.jpg","Shorter than it really is due to length contraction.","hand",(250,100,20),-101),
...
Enemy("Dr.Cassidy","'Yes, I was the one who sent you on this quest.'\n'You might believe the Quantum Order to be just and fair in their actions.'\n'But they are wrong.'\n'They wish to keep the power of the Quantum Relics to themselves so that they can decide the fate of the University.'\n'I only ever wanted to reveal the true power of Engineering Physics to the students.'\n'They thought my methods were unsafe. They thought the power I intended to give the students would\npollute their mind and cloud their judgement.'\n'I only wanted to give the Engineering Physicists true power as the supreme faculty we are meant to be!'\n'",(None),(350,125,200),125,"","","",""),
