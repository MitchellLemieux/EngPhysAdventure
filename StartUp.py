...
def Reset():
    ...
    Equipment("Banana Wires",(3,3,1),"BanWires.jpg","Alligator clips added for extra whippage.","hand",(8,0,8),-101),
    ...
    Equipment("Tarzan VHS",(0,2,1),"Tarzan.jpg","If only I had a VCR...","off-hand",(0,2,6),-101),
