...
def Reset():
    ...
    Interact("Old Car",(0,6,1,0),"An old Datsun...\nPeering into the window you can't really see much.","You open the door of the old car. You try the starter... (\S) (\S)Dead. Nothing much in here besides junk.",'old car keys','rubber chicken'),
