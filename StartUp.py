...
def Reset():
    ...
    Interact("Pack-a-Punch", (None), "Punch your fists into the air and raise a rebel yell! (\S)"
             ...
             "Pack-a-Punch Machine:(\S) To use this machine enter your item and another to sacrafice.",None, None,False),
