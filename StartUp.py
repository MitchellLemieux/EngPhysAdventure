...
def Reset():
    ...
    Map("Forest", (7, 3, 0, 4), "FOREST: (\S)",
        "You get the feeling you cannot go anywhere but back the way you came...", ('f','b'), False),
    ...
    Enemy("Brian the Weeb","'HAHA, you were a RIOT at the Phoenix last night! (\S)Also I'm really hungry, can you bring me a potato'",(2,2,1,0),(5,2,10),10,"brian's guitar","potato","THANKS MAN! I was super hungry.","That's not vegan."),
    ...
    Enemy("Erik the Sk8r","'Check out this tre flip, pretty tight eh? Also have you seen my drumstick?'",(0,0,0,0),(15,15,40),20,"Erik's frosted tips",'drumstick',"Aww thanks man! Here, you can have this!","Man, that's dumb!"),
    Enemy("Megan the Bartender","'Wait... I recognize you... you have a $420E69 tab!'",(5,4,1,0),(15,20,10),20,"meow mix",None,"","Nuuuuuuuuuuuu"),
    Enemy("Bill the MAC Cop","'Give me your student card!'",(3,5,1,0),(50,25,10),50,"solar cell",'student card',"","We aren't able to arrest you anyway!"),
    ...
    Animal("Liam the Library Dog","You talk to Liam and it seems to help. Maybe this theropy stuff does work.",(4,0,1,0), (9999, 9999, 9999), 9999, None, None,"", "","Liam cuddles beside you while you scratch/pet him. He's really good at his job."),
    ...
    Animal("Wolf", "You talk at the wolf but it just stares at you blankly.", (9, 3, 0, 4), (15, 15, 50), 20, "Wolf Meat", None, None, "ARRRROOOOOOOOOO!","You would pet the wolf but it's kinda scary. It might bite you!"),
    Animal("Small Squirrel", "You talk at the small squirel but it doesn't respond. Are you going insane?",(7,4,0,4),(5,5,30),10,"small squirrel meat",None,None,"It didn't put up much of a fight.","You put your hand out and the squirrel climbs up your hand! You play with it for a bit before carying on"),
    Animal("Big Squirrel", "You yell at it 'YOU'D MAKE A TASTY MEAL'. It doesn't seem to mind.", (4, 7, 0, 4), (5, 20, 30), 10, "big squirrel meat", None, None, "Thicc boi didn't put up much of a fight...","You put your hand out and the squirrel climbs up your hand! You play with it for a bit before carying on"),
    ...
    Interact("Lit Firepit", (None),
                 "You strike a match and throw it inside. (\S)The kindling catches quickly and the after some time the fire roars to life. (\S)After some temporary day-dreaming by the fire you notice embers start to form at the base with a yellow-hot glow.",
