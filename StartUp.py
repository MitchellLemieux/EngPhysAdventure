...
def Reset():
    ...
    Equipment("Gilded Blunderbuss",(None),"Blunderbuss.jpg","A beautiful firearm with infinite ammo.","hand",(325,5,50),-101),
    ...
    Equipment("Faraday's Cage",(None),"Faraday.jpg","THE Faraday cage.","head",(20,75,15),-101),
