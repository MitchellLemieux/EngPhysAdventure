...
Map("Alley",(0,4,1),"ALLEY:\nITB is in front of you. ETB is behind you.\nYou can enter Hatch to your right.","As you head down the narrow path between ITB and ETB you hear car horns blaring down Main St.\nYou gather up some trash and put it in a garbage can like a good McMasterian.\nThen plan you next move.",('l')),
...
Map("MDCL",(1,0,1),"MDCL:\nThe East Wing of the Hospital is to your left. Health Sci library is forward.","After a sold 5 minutes of meditation in the reflection area.\nYou make your next decision feeling refreshed.",('b','r')),
...
Equipment("Party Hat",(4,3,1),"PartyHat.jpg","Found in a Chirstmas Cracker","head",(0,5,3),-101),
#Body Items
...
Equipment("Pizza Box",(0,6,1),"PizzaBox.jpg","Fully equipped with crusted cheese.","body",(1,5,1),-101),
...
Equipment("Old Headphones",(1,7,1),"OldHeadphones.jpg","Old frayed apple headphones. Good for whipping.","hand",(5,0,5),-101),
Equipment("Empty Bottle",(4,1,1),"EmptyBottle.jpg","Dasani, more like Dishonest! Amirite?!","hand",(1,0,1),-101),
Equipment("Banana Wires",(3,3,1),"BanWires.jpg","Alligator clips added for extra whippage.","hand",(8,0,8),1),
...
Equipment("Willy Dog",(4,1,1),"Hotdog.jpg","Definitely not vegan","hand",(1,0,2),3),
Equipment("Needa Pita",(4,6,1),"Pita.jpg","Better have gotten black olives on that","hand",(2,0,1),2),
Equipment("Dirty Needle",(0,4,1),"Needle.jpg","This isn't clean. Somone find me a SharpXchange!",'hand',(7,0,5),-101),
...
Equipment("PVC Pipe",(3,7,1),"PVCPipe.jpg","Probably part of a PID project...","hand",(9,2,10),-101),
Equipment("Old Car Keys",(0,6,1),"CarKeys.jpg","Fun for babies. Not for batman","hand",(7,0,15),-101),
Equipment("Ukelele",(4,4,1),"Ukelele.jpg","Wasting away again in Margarrittaville...","hand",(6,0,5),-101),
...
Equipment("RCA TV",(5,6,1),"RCATV.jpg","They still make these?","hand",(15,20,-999),-101),
...
Equipment("Casio",(2,2,1),"Casio.jpg","This one can do integrals. That's illegal.","off-hand",(1,5,10),-101),
Equipment("Paint Brush",(3,0,1),"Brush.jpg","You can feel the emotions of a failed arts student coursing through this thing.","off-hand",(5,0,5),-101),
...
Equipment("Adderall",(4,0,1),"Adderall.jpg","Speed up, my dude!","off-hand",(0,0,50),-101),
...
Equipment("Minnicks Glasses",(None),"MinnickGlasses.jpg","The spectacles of a wizard from the High Order of the Ancient Council.","head",(100,100,100),-101),
Equipment("Kenricks Oscilloscope",(None),"Oscilloscope.jpg","The window into the electronics world...","off-hand",(0,150,50),-101),
...
Equipment("Eriks Frosted Tips",(None),"FrostedTips.jpg","Ever wanted to look rad as hell? Now you can!","head",(0,3,20),-101),
...
Equipment("ColdSteel Katana",(None),"katana.jpg","This could probably kill a buffalo fish...","hand",(18,5,20),-101),
...
Equipment("Dumbell",(1,0,1),"Dumbell.jpg","The pump is the greatest feeling in the world.","off-hand",(5,0,2),-101),
...
Equipment("Solar Cell",(None),"SolarCell.jpg","Harness the power of the Sun!\nI really hope I dont drop this...","off-hand",(1,1,1),-101),
Equipment("The Solar Ray",(None),"SolarRay.jpg","The literal power of the Sun!","hand",(100,20,50),-101),
...
Equipment("Gamma Glove",(None),"GammaGauntlet.jpg","You can feel the power radiating from this thing.","hand",(250,100,20),-101),
...
Enemy("Dr.Kleimann","'We have been looking for you.'\n'The Department is not pleased...'\n'But first, the McMaster Police have confiscated my Solar Cell, go get it.'\n'Then, maybe you are worthy of continuing this quest.'",(None),(300,150,100),300,"the solar ray","solar cell","You sit down and listen to what Dr.Kleimann has to say...\n'You have awoken an ancient even that hasn't stirred in many years'.\n'You didn't think we would find out what you did but we know all.'\n'Only The Quantum Order can assist you now, seek them out. I wish you luck...'","You have betrayed The Order!"),
...
Enemy("Dr.Nagasaki","'My grand invention is almost complete... no one can stop me!'",(0,5,2),(100,100,100),75,"flux capacitor",None,"","NOOOO! NOW I WILL NEVER PLEASE THE DARK LORD!"),
Enemy("Dan Fitzgreen","'Been a lot stirring around the faculty since last night.'\n'I used to be an adventurous student like you before the High Council and I decided to part ways.'\n'I know what you seek and I am here to help.'\n'You need to fire up that old reactor in the basement of the Tandem Accelerator.'\n'It needs some sort of high power instrument to bring it to life...'\n'I think Dr.Nagasaki has been working on something like that, he is probably somewhere in ITB.'",(None),(100,75,100),400,"","","",""),
Enemy("Kenrick","'The oscilloscope is the window into the electronic world.'",(3,4,1),(100,100,200),75,"kenricks oscilloscope",None,"","Oh no! My window to the electronics world! The Dark Lord will know I've failed him!"),
...
Enemy("Erik the Sk8r","'Check out this tre flip, pretty tight eh?'",(0,0,0),(15,15,40),20,"eriks frosted tips",None,"","Man, that's dumb!"),
...
Interact("SharpsXChange",(0,1,1),"Would you like to exchange a needle?","Needle Accepted!","dirty needle","clean needle"),
...
Interact("Ancient Mirror",(4,0,0),"It's an old mirror from a time long past.","You mutter the incantation... Suddenly, you see the reflection of Richard Feynmann himself standing behind you!\n'You have come a long way. The way of the physicist is strong with you.'\n'Here, take this it is one of the 3 Quantum Relics.\n'You will need it for what you will soon face.'","ancient incantation","gamma glove")]
