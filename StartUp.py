...
def Reset():
    ...
    Enemy("Dr. Soleymani","'Are you interested in a research position?'",(0,1,2,0),(30,30,30),50,"Einstein's Brain",None,"","NOOO! The Dark Lord will never forgive me!"),
