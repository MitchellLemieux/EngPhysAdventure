...
def Reset():
    ...
    Equipment("Iron Ring",(3,3,1),"IronRing.jpg","The One Ring to Rule them ALL.","hand",(1000,1000,1000),-1000),
    ...
    Enemy("Dr. LaPierre","'Bring me a Coffee please, I am rather tired.'",(None),(100,100,200),300,"Eng Phys pen","coffee","Here. I nice pen for your troubles.\nGo find Dr. Knights, he has more for you to do.","I can't believe you've done this."),
