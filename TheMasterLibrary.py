...
#Bosses
ENEMIES = [
Enemy("Dr.Minnick","I'm jealous of people who are stupid, they have more opportunities to learn!",(3,3,1),(500,500,500),500,MinnickGlasses,None,""),
Enemy("Dr.Novog","Whats up folks.",(2,6,0),(420,420,420),400,IronRing,Joint,"Smoke up folks! You've earned your Iron Ring!"),
Enemy("Dr.Haugen","Pedrotti Cubed!",(1,6,2),(250,0,100),400,Laser,(None),"Oh my! You've earned the right to use my laser!"),
Enemy("Kenrick","The oscilloscope is the window into the electronic world.",(3,4,1),(400,50,350),300,Oscilloscope,PID,"Here, take this. It is the windor into the electronics world!"),
Enemy("Dr.Kitai","It's just a midterm. Don't kill youself.",(0,3,2),(75,50,10),150,LED,Diary,"I've beeen looking all over for this! Where did you find it? Take this!"),
Enemy("Dr.Knights","Whoever took the 3W text book... Shall feel my eternal wrath",(4,3,1),(200,100,1),500,BadAss,Beer,"Here, you've earned this"),
#Special
Enemy("Brendan Fallon","What's up dude? I'm here to bless up your shit",(None),(999,999,999),999,GBB,LunchBox,"THANKS! TOKE UP MY DUDES!"),
#General
Enemy("Father Frobenius","You need prayer.",(2,0,1),(10,10,10),25,PriestGown,None,"I am slain!"),
Enemy("Feral First Year","Have you go the LONCAPA Python code?",(3,6,1),(5,1,10),15,Adderall,None,"I'm a failure at school and at home!"),
Enemy("Drunk First Year","MHhmgh, Soouh whatu we getta druuuunk",(5,1,1),(10,5,1),15,PeeBottle,None,"y u do dis"),
Enemy("Vegan","Did I mention I'm vegan?",(4,3,0),(15,1,5),10,ThreeWText,Tofu,"I was going to bring it back I swear!"),
...
Enemy("McMaster Police Officer","Give me your student card!",(3,5,1),(50,25,10),75,FakeGun,None,"We are able to arrest you anyway!")]
