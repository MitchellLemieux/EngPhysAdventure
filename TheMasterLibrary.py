...
FeralFirst.placeEnemy(Archway)
DrunkFirst.placeEnemy(Keyes)
Vegan.placeEnemy(Bridges)
BusDriver.placeEnemy(BusStop)
Hipster.placeEnemy(JHEField)
TAmad.placeEnemy(ETB)
ArtStudent.placeEnemy(ArtMus)
HighSchool.placeEnemy(MUSC)
MACCop.placeEnemy(Police)
