...
HardHat = Equipment("Hard Hat",(4,2,1),"HardHat.jpg","You don't really want to look like a Civil kid. But at least it protects your head.","head",(1,15,5))
FrostedTips = Equipment("Erik's Frosted Tips",(4,3,2),"FrostedTips.jpg","Ever wanted to look rad as hell? Now you can!","head",(0,3,20))
FastGlasses = Equipment("Fast Visor Glasses",(1,7,2),"FastGlasses.jpg","Damn, you are now travelling waaaay to fast. Slow down dude!","head",(3,4,30))

#Body Items
EngPhysShirt = Equipment("Eng Phys Shirt",(3,3,0),"EngPhysShirt.jpg","Rolling Rock baby! Premium Stream my ass... More like premium pain...","body",(0,10,5))
BigHitsShirt = Equipment("Big Hits Shirt",(5,2,1),"BigHits.jpg","The Shirt of the Hero of Kyvach!","body",(50,75,25))
Chainmail = Equipment("Ocon's Chainmail",(3,6,0),"OconMail.jpg","The sacred chainmail forged by the legend himself","body",(75,100,50))
Hazmat = Equipment("Hazmat Suit",(2,5,1),"Hazmat.jpg","Protection from all sorts of McCrindle farts...","body",(0,10,10))
MAPShirt = Equipment("McMaster map",(1,2,1),"MACMap.jpg","A map of McMaster you can... wear? I guess?","body",(1,5,5))
PriestGown = Equipment("A Priest Gown",(2,0,2),"Gown.jpg","Wearing this gives people the impression you are a holy person...","body",(1,5,3))
PizzaBox = Equipment("Pizza Box",(3,1,1),"PizzaBox.jpg","Fully equipped with crusted cheese.","body",(1,5,1))
Apron = Equipment("Starbucks Apron",(5,0,1),"Apron.jpg","If you put this on do you immediately know how to make a frappe?","body",(1,5,5))

#Hand Items
MSP430 = Equipment("MSP430",(2,3,1),"MSP430.jpg","A literal piece of garbage.","hand",(-5,-5,-5))
OldHeadphones = Equipment("Old Headphones",(1,7,1),"OldHeadphones.jpg","Old frayed apple headphones. Good for whipping.","hand",(5,0,5))
EmptyBottle = Equipment("Empty Bottle",(5,1,1),"EmptyBottle.jpg","Dasani, more like Dishonest! Amirite?!","hand",(1,0,1))
BanWires = Equipment("Banana Wires",(3,3,1),"BanWires.jpg","Alligator clips added for extra whippage.","hand",(8,0,8))
Wrench = Equipment("Wrench",(1,3,1),"Wrench.jpg","It's a wrench. 22mm.","hand",(10,0,0))
Pencil = Equipment("Pencil",(2,4,1),"Pencil.jpg","HB2. Sharpened.","hand",(2,0,5))
Crucifix = Equipment("Crucifix",(2,0,1),"Crucifix.jpg","The Power of Chirst compels you!","hand",(5,0,4))
Racket = Equipment("Squash Racket",(5,0,1),"Racket.jpg","Dr.Buijs' Racket? Voltage Divider!","hand",(5,0,10))
HotDog = Equipment("Willy Dog",(4,1,1),"Hotdog.jpg","Definitely not vegan","hand",(1,0,2))
Pita = Equipment("Needa Pita",(3,6,1),"Pita.jpg","Better have gotten black olives on that","hand",(2,0,1))
Needle = Equipment("Dirty Needle",(1,1,1),"Needle.jpg","This isn't clean. Somone find me a SharpXchange!",'hand',(10,0,5))
Plunger = Equipment("Used Plunger",(5,0,0),"Plunger.jpg","Used. Lovely...","hand",(10,-10,10))
WineBottle = Equipment("Broken Wine Bottle",(4,3,1),"WineBottle.jpg","A broken wine bottle from 1996, good year.","hand",(25,0,15))
Condom = Equipment("Used Condom",(2,1,1),"Condom.jpg","The audacity of some people to leave their filth around. Probably would suck to get hit by...","hand",(10,-10,-10))
PhysPen = Equipment("Eng Phys Pen",(3,3,0),"PhysPen.jpg","It would be amazing if this thing actually worked. Plug it in and find all of 2P04","hand",(15,0,10))
ButterKnife = Equipment("Butter Knife",(3,6,1),"ButterKnife.jpg","Meant for spreading, not stabbing...","hand",(4,0,5))
PeeBottle = Equipment("Pee Bottle",(2,1,1),"PeeBottle.jpg","It is literally a bottle of urine.","hand",(10,0,0))
Tofu = Equipment("Tofu",(4,3,0),"Carrot.jpg","Vegan's delight","hand",(1,1,5))

#Off-Hand Items
Coffee = Equipment("Coffee",(2,4,1),"Coffee.jpg","The fuel of thinkers.","off-hand",(10,0,25))
Griffiths = Equipment("Griffiths Electrodynamics",(2,4,2),"Griffiths.jpg","The holy scriptures which govern the fabric of our being","off-hand",(0,100,10))
Pint = Equipment("An Ice-Cold Pint",(4,3,1),"Pint.jpg","Ale of the Gods.","off-hand",(3,0,-5))
Diary = Equipment("Diary of the Fallen",(3,6,0),"Diary.jpg","The personal notes of an ancient Hero.","off-hand",(69,69,69))
Shield = Equipment("Wood Shield",(4,3,2),"Shield.jpg","An old wooden shielf used in a play, you think...","off-hand",(5,75,-5))
Casio = Equipment("Casio",(2,2,1),"Casio.jpg","This one can do integrals. That's illegal.","off-hand",(5,5,30))
Brush = Equipment("Paint Brush",(3,0,1),"Brush.jpg","You can feel the emotions of a failed arts student coursing through this thing.","off-hand",(5,-10,20))
Lenovo = Equipment("Lenovo Laptop",(1,5,2),"Lenovo.jpg","This heap of computing majesty could block bullets... I think...","off-hand",(5,30,-5))
Painting = Equipment("Priceless Painting",(3,0,1),"Painting.jpg","This painting is supposed to be worth millions...","off-hand",(1,20,5))
LunchBox = Equipment("Brendan Fallons Lunchbox",(3,3,0),"Lunchbox.jpg","The Lunch Box of an Ancient Hero. Full of samosas","off-hand",(5,25,15))
Peanut = Equipment("Jar of Peanut Butter",(4,0,1),"Peanut.jpg","Death paste to those who are allergic... Could prove effective...","off-hand",(0,5,5))
Adderall = Equipment("Adderall",(4,0,1),"Adderall.jpg","Speed up, my dude!","off-hand",(0,0,50))
Drumstick = Equipment("Drumstick",(4,3,2),"Drumstick.jpg","'Property of E-Smooth'","off-hand",(0,15,25))
